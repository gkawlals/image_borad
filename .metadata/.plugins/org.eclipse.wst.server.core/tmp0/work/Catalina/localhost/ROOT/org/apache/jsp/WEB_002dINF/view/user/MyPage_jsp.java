 ...
 * Generated at: 2021-06-07 08:59:29 UTC
...
public final class MyPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String user_id = CmmUtil.nvl((String)session.getAttribute("SS_USER_ID"));
      ...
      out.write("                        <div class=\"user_name\" id=\"SS_USER_ID\">");
 ...
 for(int i = 1; i <= rList.size(); i++){ 
      ...
      out.write("</section>\n");
      out.write("<script>\n");
      out.write("/* \tfunction update_page(){\n");
      out.write("\t\tvar update_page = confirm(\"수정 및 삭제를 원하시나요? (확인 : 수정 , 취소 : 삭제 )\");\n");
      out.write("\t\tif( update_page == true ){\n");
      out.write("\t\t\tlocation.replace(\"../image/imageDetail.do\");\n");
      out.write("\t\t}else {\n");
      out.write("\t\t\tvar del_evt = confirm(\" 정말 삭제 하시겠습니까? ( 확인 : 삭제, 취소 : 돌아기기)\")\n");
      out.write("\t\t\tif(del_evt == true ){\n");
      out.write("\t\t\t\tlocation.replace(\"../image/delImage.do\");\n");
      out.write("\t\t\t}else{\n");
      out.write("\t\t\t\tlocation.replace(\"../image/MyPage.do\");\n");
      out.write("\t\t\t}\n");
      out.write("\t\t}\n");
      out.write("\t} */\n");
      out.write("\t\n");
      ...
      out.write("\t\t\t\tresHTML += '</button>';\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\tif( data.length == 0){\n");
      out.write("\t\t\t\t\tresHTML += '<form action=\"../image/imageDetail.do\">';\n");
