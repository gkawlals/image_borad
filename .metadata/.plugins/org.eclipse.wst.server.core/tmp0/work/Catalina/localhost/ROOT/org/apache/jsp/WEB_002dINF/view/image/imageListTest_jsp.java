 ...
 * Generated at: 2021-05-08 08:06:58 UTC
...
public final class imageListTest_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	List<ImageDTO> rList = (List<ImageDTO>) request.getAttribute("rList");
      ...
      out.write("        </section>\n");
      out.write("    </header>\n");
      out.write("\t\t<div class=\"hidden_menu\">\n");
      out.write("\t\t    <div class=\"scroll_inner\">\n");
      out.write("\t\t    \t<div class=\"user\">\n");
      out.write("\t\t    \t\t<div class=\"thumb_img\">\n");
      out.write("\t\t    \t\t\t<img src=\"../resourceImg/imgs/thumb.jpeg\"/>\n");
      out.write("\t\t    \t\t</div>\n");
      out.write("\t\t    \t</div>\n");
      out.write("\t\t    </div>\n");
      out.write("\t\t </div>\n");
 ...
 for(ImageDTO userInfo : rList) { 
      ...
      out.write("                                <div style=\"text-align : center;\" ><h1>");
      ...
      out.write("\t\t\t\t\tresHTML += '<input type=\"text\"/>';\n");
      out.write("\t\t\t\t\tresHTML += '<input type=\"text\"/>';\n");
      out.write("\t\t\t\t\tresHTML += '<input type=\"text\"/>';\n");
      ...
      out.write("\t\t\t\t\t\tresHTML += '<input type=\"text\"/>';\n");
      out.write("\t\t\t\t\t\tresHTML += '<br/>';\n");
      out.write("\t\t\t\t\t\tresHTML += '<img  src=\"\" width = 300px height= 300px name=\"imgfile\" />';\n");
      out.write("\t\t\t\t\t\tresHTML += '<br/>';\n");
      out.write("\t\t\t\t\t\tresHTML += '<input type=\"text\"/>';\n");
      out.write("\t\t\t\t\t\tresHTML += '<br>';\n");
      out.write("\t\t\n");
      ...
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\tresHTML += '<input type=\"text\" value=\"' + data.getImage_no() +'\" />';\n");
      out.write("\t\t\t\t\t\t\tresHTML += '<input type=\"text\" value=\"'+ data.getReg_id() +'\"/>';\n");
      out.write("\t\t\t\t\t\t\tresHTML += '<input type=\"text\" value=\"'+ data.getOne_title() +'\"/>';\n");
      out.write("\t\t\t\t\t\t\tresHTML += '<br/>';\n");
      out.write("\t\t\t\t\t\t\tresHTML += '<img src=\"../resourceImg/Image/'+data.getSave_folder_name()+'/'+ data.getSave_file_name()'\" width = 300px height= 300px name=\"imgfile\"/>';\n");
      out.write("\t\t\t\t\t\t\tresHTML += '<br/>';\n");
      out.write("\t\t\t\t\t\t\tresHTML += '<input type=\"text\" value =\"'+ data.getChg_dt()+'\"/>';\n");
      out.write("\t\t\t\t\t\t\tresHTML += '<br>';\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t}\n");
