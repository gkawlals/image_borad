 ...
 * Generated at: 2021-06-22 02:42:58 UTC
...
public final class circle_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String user_id = CmmUtil.nvl((String)session.getAttribute("SS_USER_ID"));
      ...
      out.write("\t\t\t<br><br><br>\n");
      out.write("\t\t\t <form enctype=\"multipart/form-data\" action=\"/image/circleUpload.do\" method=\"post\">\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t<input type=\"button\" onclick='document.all.circleUpload.click();' id=\"circleBtn\" value=\"test\" name=\"circleBtn\" />\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t<input type=\"file\" name=\"circleUpload\" style=\"display:none\" onchange=\"circleIn()\" >\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"cir_title\" name=\"cir_title\" style=\"display:none\"/>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"location\" name=\"location\" style=\"display:none\"/>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t<input type=\"submit\" name=\"circleInsert\" id=\"circleInstert\" style=\"display:none\"/>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t</form>\n");
      out.write("\t\t\t<!-- 시연을 위해 좌표를 같게 만드는 버튼 -->\n");
      out.write("\t\t\t<input type=\"button\" onclick=\"Geo()\" id=\"geo\" value=\"geotest\" name=\"geo\">\n");
      out.write("\t\t<script> \n");
      out.write("\t\tvar location;\n");
      out.write("\t\t// 좌표가 같을 때 실행할 수 있는 사진 저장 \n");
      out.write("\t\t\tfunction circleIn(){\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t\t\tconsole.log(user_id);\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\tif (Rlat == lat && Rlon == lon){\n");
      out.write("\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\tclearInterval(MakeLocation);\n");
      out.write("\n");
      out.write("\t           \t \tif(!user_id){\n");
      out.write("\t           \t\t\t\t\n");
      out.write("\t           \t\t\t\talert(\"로그인을 하지않으면 실행 할 수 없습니다.\");\n");
      ...
      out.write("\t           \t\t\t}else{ \n");
      out.write("\t           \t\t\t\t\n");
      out.write("\t\t           \t\t\tvar ppt2 = prompt(\"15자 이내의 간단한 제목을 정해주세요!\",\"\");\n");
      out.write("\t\t           \t\t\t\n");
      out.write("\t\t           \t\t\tif (!ppt2){\n");
      out.write("\t\t           \t\t\t\t\n");
      out.write("\t\t           \t\t\t\talert(\" 제목을 지어 주셔야 합니다 !\");\n");
      ...
      out.write("\t\t           \t\t\t\tconsole.log(\" 제목을 지어라 \");\n");
      out.write("\t\t           \t\t\t\t\n");
      out.write("\t\t           \t\t\t}else if( ppt2.length > 15){\n");
      out.write("\t\t           \t\t\t\t\n");
      out.write("\t\t           \t\t\t\talert(\" 제목의 길이가 너무 길어 저장에 실패 했습니다.\");\n");
      out.write("\t\t           \t\t\t\t\n");
      out.write("\t\t           \t\t\t}else {\n");
      out.write("\t\t           \t\t\t\t\n");
      out.write("\t\t           \t\t\t\t$('input[name=cir_title]').attr('value', ppt2);\n");
      out.write("\t\t           \t\t\t\t\n");
      out.write("\t\t           \t\t\t\t$('input[name=location]').attr('value', Rlat + '/' + Rlon);\n");
      out.write("\t\t           \t\t\t\t\n");
      out.write("\t\t           \t\t\t\tconsole.log(location);\n");
      out.write("\t\t           \t\t\t\tconsole.log(cir_title.value);\n");
      out.write("\t\t           \t\t\t\t\n");
      out.write("\t\t\t           \t\t\tdocument.all.circleInsert.click();\n");
      out.write("\t\t           \t\t\t\t\n");
      out.write("\t\t           \t\t\t}\n");
      out.write("\t\t           \t\t}\n");
      out.write("\t           \t\t\n");
      out.write("\t\t\t\t\t}else {\n");
      out.write("\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\talert(\" 좌표가 달라 실행할 수 없습니다.\");\n");
      out.write("\t\t\t\t\t}\n");
      out.write("           \t\t\t\n");
      out.write("\t\t\t\t}\n");
      out.write("\t\t</script>\n");
      ...
      out.write("\t\t\t\t\t    \n");
      out.write("\t\t\t\t\t    arMarker.push(marker);\n");
      out.write("\t\t\t\t\t    \n");
      out.write("\t\t\t      });\n");
      out.write("\t\t\t    \n");
      ...
      out.write("\t\t}\n");
      out.write("\t\t\n");
      out.write("\t\t//  test를 위한 좌표 조작 \n");
      out.write("\t\tfunction Geo(){\n");
      out.write("\t\t\t\n");
      out.write("\t\t\tRlat = lat; \n");
      out.write("\t\t\tRlon = lon;\n");
      out.write("/* \t\t\tif(Rlat == lat && Rlon == lon){\n");
      ...
      out.write("\t\t        });\n");
      out.write("\t\t        // 지우기 위해 기억해주는 배열에 추가하기 \n");
      out.write("\t\t        arrayLine.push(polyline);\n");
      out.write("\t\t        // \n");
      out.write("\t\t        \n");
      out.write("\t\t\t\tif(Rlat == lat && Rlon == lon){\n");
      out.write("\t\t\t\t\tclearInterval(MakeLocation);\n");
      out.write("\t\t\t\t\tdocument.getElementById('circleBtn').click();\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t}else {\n");
      out.write("\t\t\t\t\t  MakeLocation;\n");
      out.write("\t\t\t\t}\n");
      out.write("\t\t}\n");
      out.write("\t\t\n");
      out.write("\t\t<!-- 여기서 계속 자기자리를 찍어주는 함수를 실행시켜 계속해서 자기자리를 찍으면서 직선과 마커를 찍었다 지웠다 하면 됨-->\n");
      out.write("\t       var MakeLocation = setInterval( function(){\n");
      out.write("\t    \t   \n");
      out.write("\t        \t\tif(Rlat > 0 && Rlon > 0){\n");
      out.write("\t\t\t    \t\t\t\t\n");
      out.write("\t\t\t    \t\t\t\tconsole.log('5초마다 좌표 찍기');\n");
      out.write("\t\t\t    \t\t\t\tconsole.log(lat, lon);\n");
      out.write("\t\t\n");
      out.write("\t\t \t\t\t\t\t\t// 지도에 마커를 생성하고 표시한다\n");
      out.write("\t\t \t\t\t    \t\t marker = new kakao.maps.Marker({\n");
      ...
      out.write("\t\tfunction delarMarker(map) {\n");
      out.write("\t\t    for (var i = 0; i < arMarker.length; i++) {\n");
      out.write("\t\t    \tarMarker[i].setMap(null);\n");
      out.write("\t\t    }            \n");
      out.write("\t\t}\n");
      out.write("\t\t\n");
      out.write("\t\t// 배열에 추가된 마커들을 삭제하는 함수입니다\n");
